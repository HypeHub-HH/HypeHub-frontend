      ...
      <Grid container spacing={2} display={"flex"} justifycontent={"center"} padding={"1dvw"}>
        ...
        <Grid md={6} display={'flex'} flexDirection={'column'} justifycontent={'center'} alignSelf={'center'}>
          <JoinText variant="h5" component="div" align="justify">
            Dive into a world where fashion is more than just clothing, it's an expression of individuality, creativity,
            and passion. Here, we've created a haven for fashion aficionados to share their favorite fashion items,
            clothes, and outfits with a community that truly understands and appreciates the art of dressing.
          </JoinText>
