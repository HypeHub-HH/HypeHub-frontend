...
const ImageCropper = ({ setSelectedImages, selectedImages,addedImages,setAddedImages }) => {
  ...
  const showCroppedImage = async () => {
    try {
      ...
      setSelectedImages([...selectedImages, {url: croppedImageUrl, id: 0}]);
      setAddedImages([...addedImages, croppedImageUrl])
      setImageSrc(null);
    } catch (e) {
      console.error(e);
    }
